...
struct  MonoCameraConfiguration_t726  : public Object_t
{
	// UnityEngine.Camera Vuforia.MonoCameraConfiguration::mPrimaryCamera
	Camera_t115 * ___mPrimaryCamera_0;
	...
	Action_t100 * ___mOnVideoBackgroundConfigChanged_3;
	...
	Dictionary_2_t727 * ___mVideoBackgroundBehaviours_4;
	// UnityEngine.Rect Vuforia.MonoCameraConfiguration::mViewportRect
	Rect_t87  ___mViewportRect_5;

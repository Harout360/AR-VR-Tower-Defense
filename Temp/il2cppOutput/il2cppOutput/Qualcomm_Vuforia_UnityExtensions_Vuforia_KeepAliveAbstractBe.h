...
// Vuforia.KeepAliveAbstractBehaviour
struct  KeepAliveAbstractBehaviour_t38  : public MonoBehaviour_t2
{
	...
	List_1_t874 * ___mHandlers_9;
};
struct KeepAliveAbstractBehaviour_t38_StaticFields{
	// Vuforia.KeepAliveAbstractBehaviour Vuforia.KeepAliveAbstractBehaviour::sKeepAliveBehaviour
	KeepAliveAbstractBehaviour_t38 * ___sKeepAliveBehaviour_8;
};

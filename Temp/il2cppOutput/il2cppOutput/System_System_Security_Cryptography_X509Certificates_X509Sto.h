...
struct  X509Store_t1347  : public Object_t
{
	...
	X509Certificate2Collection_t1341 * ___list_2;
	...
	X509Store_t1150 * ___store_4;
};
struct X509Store_t1347_StaticFields{
	...
	Dictionary_2_t282 * ___U3CU3Ef__switchU24mapF_5;
};

...
struct  CameraDeviceImpl_t778  : public CameraDevice_t740
{
	...
	VideoModeData_t739  ___mVideoModeData_8;
...
struct CameraDeviceImpl_t778_StaticFields{
	// Vuforia.WebCamImpl Vuforia.CameraDeviceImpl::mWebCam
	WebCamImpl_t781 * ___mWebCam_3;
};
